...
| `codex-telegram-bridge-mcp` | Sends and receives Telegram messages through allowlisted chats, supports approval prompts, and can relay Telegram messages into an active Codex session. |
