...
| `codex-telegram-bridge-mcp` | allowlist된 Telegram 채팅으로 메시지를 송수신하고, workflow 승인, Codex native permission request용 user-level hook 자동 설치, Telegram 메시지의 Codex 세션 릴레이를 지원합니다. |
